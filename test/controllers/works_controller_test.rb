...
describe WorksController do
  ...
  describe "guest users" do
    it "requires login for upvote" do
      expect {
        post upvote_path(existing_work.id)
      }.wont_change "Vote.count"
      must_redirect_to root_path
    ...
    it "require login for create" do
      new_work = { work: { title: "Clean CD", category: "album" } }
    ...
    it "require login for show" do
      get work_path(Work.first)
      must_redirect_to root_path
    end

    it "require login for edit" do
      get work_path(Work.first)
      must_redirect_to root_path
    end

    it "require login for update" do
      updates = { work: { title: "Clean Computer" } }
    ...
    it "require login for destoy" do
      expect {
        delete work_path(existing_work.id)
